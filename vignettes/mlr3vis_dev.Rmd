...
## ROC based on generateThreshVsPerfData from Benchmark

This figure is correct. The curve looks a little weird because of the performance of classif.featureless in the data.

```{r}

plotROCCurves(performanceData)
